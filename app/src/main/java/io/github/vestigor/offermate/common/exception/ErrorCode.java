package io.github.vestigor.offermate.common.exception;
...
public enum ErrorCode {
    ...
    // ========== 用户认证模块错误 9xxx ==========
    UNKNOW_USER_VISIT(9001,"未知用户访问"),
    DUPLICATE_USERNAME(9002, "用户名已存在"),
    USER_NOT_FOUND(9003, "用户不存在"),
    BAD_CREDENTIALS(9004, "用户名或密码错误"),
    INVALID_PASSWORD(9005, "旧密码不正确"),
    SAME_PASSWORD(9006, "新密码与旧密码相同"),
    INVALID_TOKEN(9007, "JWT 解析、验证或签名校验失败"),
    TOKEN_EXPIRED(9008, "Token已过期"),
    TOKEN_BLACKLISTED(9009, "Token已被注销");
