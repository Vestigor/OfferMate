package io.github.vestigor.offermate.common.result;

import io.github.vestigor.offermate.common.constant.CommonConstants;
...
public class Result<T> {
    ...
    public boolean isSuccess() {
        return this.code == CommonConstants.StatusCode.SUCCESS;
    }
}
