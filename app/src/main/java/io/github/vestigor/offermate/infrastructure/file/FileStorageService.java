...
public class FileStorageService {
    ...
    public String getFileUrl(String fileKey) {
        return String.format("%s/%s/%s", storageConfigProperties.getEndpoint(), storageConfigProperties.getBucket(), fileKey);
    }
    ...
    public void ensureBucketExists() {
        try {
            ...
            log.info("存储桶不存在，正在创建: {}", storageConfigProperties.getBucket());
