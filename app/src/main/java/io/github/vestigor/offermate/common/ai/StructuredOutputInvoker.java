package io.github.vestigor.offermate.common.ai;
...
""";
    ...
    public <T> T invoke(
        ...
        for (int attempt = 1; attempt <= maxAttempts; attempt++) {
            String attemptSystemPrompt = attempt == 1 ?
                    systemPromptWithFormat : buildRetrySystemPrompt(systemPromptWithFormat, lastError);
            try {
    ...
    public String buildRetrySystemPrompt(String systemPromptWithFormat, Exception lastError) {
