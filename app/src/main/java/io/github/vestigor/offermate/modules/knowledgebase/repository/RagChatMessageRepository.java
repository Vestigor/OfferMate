...
import io.github.vestigor.offermate.modules.knowledgebase.model.entity.RagChatMessageEntity.MessageType;
...
public interface RagChatMessageRepository extends JpaRepository<RagChatMessageEntity, Long> {
     ...
     * 统计指定用户的消息数（即用户提问次数）
     */
    long countBySession_UserIdAndType(Long userId, MessageType type);
}
