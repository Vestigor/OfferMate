package io.github.vestigor.offermate.infrastructure.redis;

import io.github.vestigor.offermate.modules.interview.model.dto.InterviewQuestionDTO;
import io.github.vestigor.offermate.modules.interview.model.dto.InterviewSessionDTO;
...
public class InterviewSessionCache {
    ...
    public static class CachedSession implements Serializable {
        ...
        private InterviewSessionDTO.SessionStatus status;
        ...
        public CachedSession(String sessionId, String resumeText, Long resumeId,
                             ...
                             InterviewSessionDTO.SessionStatus status, ObjectMapper objectMapper) {
     ...
     * 更新会话状态
     */
    public void updateSessionStatus(String sessionId, InterviewSessionDTO.SessionStatus status) {
    ...
    private boolean isUnfinishedStatus(InterviewSessionDTO.SessionStatus status) {
        return status == InterviewSessionDTO.SessionStatus.CREATED || status == InterviewSessionDTO.SessionStatus.IN_PROGRESS;
    }
}
